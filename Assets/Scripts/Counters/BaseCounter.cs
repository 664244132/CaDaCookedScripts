...
public class BaseCounter : MonoBehaviour, IKitchenObjectParent
{
    ...
    public virtual void Interact(Player player) //เช็ค player เเละ basecounter
    {
        Debug.LogError("BaseCounter.Interact();");
    }

    public virtual void InteractAlternate(Player player) //เช็ค player เเละ basecounter
    {
