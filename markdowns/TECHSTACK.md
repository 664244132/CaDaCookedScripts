...
- **Action Map (`Player`):**
  ...
  - `Interact` (`Button`): การกดปุ่มมีปฏิสัมพันธ์หลัก (`E` หรือปุ่มบน Controller) และการไล่แมว
  - `InteractAlternate` (`Button`): การกดปุ่มทำงานพิเศษ เช่น หั่นอาหาร หรือฉีดถังดับเพลิง (`F` หรือปุ่มบน Controller)
