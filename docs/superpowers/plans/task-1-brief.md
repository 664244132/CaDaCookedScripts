...
## Global Constraints
- Target colors: White (#FFFFFF) and Orange (#FFA500).
- Do not delete existing scripts or components, only modify RectTransform, Image colors, and LayoutGroups.
...
**Interfaces:**
- Consumes: GameScene UI GameObjects
- Produces: Modified GameScene UI GameObjects
...
Run: `echo "Wait for Unity to compile"`
Expected: No compiler errors in Unity.
